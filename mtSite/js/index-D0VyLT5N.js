...
function create_else_block$1(ctx) {
  ...
  return {
    c() {
      ...
      t4 = space();
      label = element("label");
      label.textContent = "Включить видео/звуковой комментарий";
      t6 = space();
      div3 = element("div");
      div1 = element("div");
      p3 = element("p");
      ...
      attr(input0, "class", "textfield svelte-10m9pd5");
      attr(input0, "type", "text");
      attr(input0, "maxlength", "100");
      attr(input0, "size", "32");
      attr(input0, "placeholder", "Ваше имя");
      input0.required = true;
      attr(p0, "class", "req svelte-10m9pd5");
      attr(input1, "name", "email");
      attr(input1, "tabindex", "0");
      attr(input1, "class", "textfield svelte-10m9pd5");
      attr(input1, "type", "email");
      attr(input1, "maxlength", "42");
      attr(input1, "placeholder", "Ваш email");
      input1.required = true;
      attr(p1, "class", "req svelte-10m9pd5");
      attr(input2, "type", "checkbox");
      attr(input2, "name", "record");
      attr(input2, "class", "svelte-10m9pd5");
      attr(label, "for", "record");
      attr(p2, "class", "checkbox");
      attr(p3, "class", "prepareVideo svelte-10m9pd5");
      attr(div0, "class", "paused svelte-10m9pd5");
      attr(p5, "class", "recordNote svelte-10m9pd5");
      attr(p6, "class", "recordTimer svelte-10m9pd5");
      attr(video0, "class", "replayVideo svelte-10m9pd5");
      video0.autoplay = true;
      video0.playsInline = true;
      video0.controls = true;
      attr(video0, "preload", "auto");
      attr(video1, "class", "userMedia svelte-10m9pd5");
      attr(video1, "width", "400");
      video1.playsInline = true;
      attr(div1, "class", "visuals svelte-10m9pd5");
      attr(button0, "class", "record svelte-10m9pd5");
      attr(button1, "class", "pause svelte-10m9pd5");
      attr(button2, "class", "resume svelte-10m9pd5");
      attr(button3, "class", "preview svelte-10m9pd5");
      attr(button4, "class", "recordAgain svelte-10m9pd5");
      attr(div2, "class", "buttons svelte-10m9pd5");
      attr(div3, "class", "teleMail svelte-10m9pd5");
      attr(textarea, "class", "textfield svelte-10m9pd5");
      ...
      attr(p7, "class", "req svelte-10m9pd5");
      attr(button5, "class", "submit active svelte-10m9pd5");
      attr(p8, "class", "req submit svelte-10m9pd5");
      attr(fieldset, "class", "svelte-10m9pd5");
    },
    m(target, anchor) {
...
function create_if_block$1(ctx) {
  ...
  return {
    c() {
      ...
      attr(p, "class", "req svelte-10m9pd5");
    },
    m(target, anchor) {
...
function create_fragment$1(ctx) {
  ...
  return {
    c() {
      ...
      if_block.c();
      attr(section, "class", "contact active svelte-10m9pd5");
    },
    m(target, anchor) {
...
const host$1 = "//moretele.ru";
function instance$1($$self, $$props, $$invalidate) {
  const sendm = host$1 + "/sendm";
  let username, email, message, linkMp4, fileName, avatar, mailSended;
  ...
  async function createRecorder() {
    ...
    $$invalidate(4, mrecorder = await self.mtNs.Mrecorder({
      userMedia,
      timeLimit,
      url: `${host$1}/cvideo`,
      uuid: uuid || 4,
      ...
      stateInfo: async (ev) => {
        ...
        $$invalidate(5, recordTimer.innerHTML = Utils.hms(eTime, [60]), recordTimer);
        if (type === "media" && userMedia) {
          $$invalidate(7, userMedia.srcObject = ev.stream.clone(), userMedia);
          $$invalidate(7, userMedia.volume = 0.2, userMedia);
          userMedia.play();
        } else if (type === "stop")
          ;
  ...
  function getAvatar() {
    ...
    img1.onload = function() {
      ...
      ctx.drawImage(img1, 0, 0, width, height, c[0] - 40, c[1] - 40, 80, 120);
      avatar = canvas.toDataURL();
    };
    img1.src = "./play.png";
  }
  function setMedia(ev) {
  ...
  async function send() {
    ...
    if (res.status === "ok")
      $$invalidate(3, mailSended = res.status);
    setTimeout(
      () => {
        location.reload();
      },
  ...
  function p6_binding($$value) {
    binding_callbacks[$$value ? "unshift" : "push"](() => {
      recordTimer = $$value;
      $$invalidate(5, recordTimer);
    });
  }
  function video0_binding($$value) {
    binding_callbacks[$$value ? "unshift" : "push"](() => {
      replayVideo = $$value;
      $$invalidate(8, replayVideo);
    });
  }
  function video1_binding($$value) {
    binding_callbacks[$$value ? "unshift" : "push"](() => {
      userMedia = $$value;
      $$invalidate(7, userMedia);
    });
  }
  const click_handler = () => {
...
function create_else_block(ctx) {
  ...
  return {
    c() {
      details = element("details");
      summary = element("summary");
      summary.textContent = "Форма задать вопрос";
      t1 = space();
      fieldset = element("fieldset");
      p0 = element("p");
      input0 = element("input");
